...
import { buildPropositionsFromReviewedRows, type ImportPreviewRow } from "@/lib/imports/product-import.service";
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    console.error("[product_import_commit] failed", { errorName: error instanceof Error ? error.name : "UnknownError", errorMessage: error instanceof Error ? error.message : "Unknown error" });
