...
export async function POST(
  ...
  try {
    ...
    const security = await authorizeLegacyMutation({ authContext, actionName: "customer.archive", requiredPermission: "customers.archive", entityType: "Customer", entityId: customerId });
