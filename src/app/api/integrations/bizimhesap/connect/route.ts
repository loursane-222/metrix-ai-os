...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    const security = await authorizeLegacyMutation({ authContext: auth, actionName: "bizimhesap.connect", requiredPermission: "integrations.write", entityType: "IntegrationConnection" });
