...
import { buildPropositionsFromReviewedRows, type ImportPreviewRow } from "@/lib/imports/production-import.service";
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    console.error("[production_import_commit] failed", { errorName: error instanceof Error ? error.name : "UnknownError", errorMessage: error instanceof Error ? error.message : "Unknown error" });
