...
import { buildPropositionsFromReviewedRows, type ImportPreviewRow } from "@/lib/imports/offer-import.service";
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    console.error("[offer_import_commit] failed", { errorName: error instanceof Error ? error.name : "UnknownError", errorMessage: error instanceof Error ? error.message : "Unknown error" });
