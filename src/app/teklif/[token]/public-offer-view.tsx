...
type PublicOffer = { id: string; title: string; customerName: string; amount: string | null; currency: string; status: OfferStatus; customerNote: string | null; validUntil: string | null; paymentTerm: string | null; deliveryTerm: string | null; deliveryMethod: string | null; organizationName: string; items: Array<{ id: string; name: string; unit: string | null; quantity: string; unitPriceCents: string; lineTotalCents: string }> };
