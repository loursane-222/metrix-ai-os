...
function humanLabel(key: string) { return ({ count: "Toplam kayıt", displayName: "Müşteri", customerName: "Müşteri", balanceCents: "Toplam bakiye", dueDate: "Vade", createdAt: "Oluşturulma", updatedAt: "Güncelleme", status: "Durum", amount: "Toplam tutar", totalAmount: "Toplam tutar", title: "Başlık", description: "Açıklama", invoiceNumber: "Fatura numarası", invoiceTitle: "Fatura", paymentCount: "Tahsilat sayısı", paymentReferences: "Tahsilatlar", currency: "Para birimi", priority: "Öncelik", priorityLabel: "Öncelik", priorityExplanation: "Öncelik faktörleri", fulfillmentSummary: "Karşılama özeti", reservationStatus: "Rezervasyon durumu", deliveryProgressSummary: "Teslimat ilerlemesi", revisionHistorySummary: "Revizyon geçmişi", orderNumber: "Sipariş no", stock: "Stok", name: "Ürün" } as Record<string, string>)[key] ?? key.replace(/([A-Z])/g, " $1").replace(/^./, (c) => c.toUpperCase()); }
