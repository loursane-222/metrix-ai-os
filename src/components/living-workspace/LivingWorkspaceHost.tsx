...
function SurfaceRenderer({ surface, data }: { surface: WorkspaceSurfaceDescriptor; data: unknown }) {
  if (surface.type === "management-summary") return <ManagementSummarySurface data={data}/>;
  const record = data as { customers?: Array<Record<string, unknown>>; products?: Array<Record<string, unknown>> };
