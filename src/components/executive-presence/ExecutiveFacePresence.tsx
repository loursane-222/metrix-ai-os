...
/**
 * NEXT-native prop surface: takes the already-resolved presence state
 * directly, rather than the approved LIVE component's
 * {behaviorStatus, voicePresence} pair (resolved via resolveExecutiveFaceState,
 * which is coupled to the legacy voice/behavior runtime this operation does
 * not port). The canvas particle rendering itself is unchanged.
 */
export function ExecutiveFacePresence({ state }: { state: ExecutiveFaceState }) {
