...
export function resolveCompanyGoalCreateCommandRequest(payload: { utterance: string }): Promise<Result<{ outcome: unknown }>> { return request("/api/company/actions/goal-create-command", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify(payload) }); }
export function resolveCompanyAssetCreateCommandRequest(payload: { utterance: string }): Promise<Result<{ outcome: unknown }>> { return request("/api/company/actions/asset-create-command", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify(payload) }); }
export function resolveCompanySourceCreateCommandRequest(payload: { utterance: string }): Promise<Result<{ outcome: unknown }>> { return request("/api/company/actions/source-create-command", { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify(payload) }); }
