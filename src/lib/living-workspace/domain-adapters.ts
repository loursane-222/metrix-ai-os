...
export const DOMAIN_SURFACE_ADAPTERS: Readonly<Record<WorkspaceDomain, DomainSurfaceAdapter>> = Object.freeze({
  ...
  notification: Object.freeze({ domainKey:"notification", entityTypes:["Notification"], endpoint:"/api/notifications", fieldRegistry:["title","body","severity","type","isRead","createdAt"], allowedListColumns:["title","severity","type","isRead","createdAt"], allowedFilters:["severity","type","isRead"], allowedSorts:["createdAt"], summaryMetrics:["count","unreadCount"], supportedQuickActions:["open-full-page"], fullPageRoutes:["/metrix/notifications"], permissionRequirements:["notifications.read"], emptyStateCode:"NOTIFICATION_CANONICAL_DATA_EMPTY", dataQualityCode:"NOTIFICATION_MODEL_DATA_QUALITY" }),
});
