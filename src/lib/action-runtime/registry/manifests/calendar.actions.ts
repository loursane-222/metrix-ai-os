...
export const calendarActionDefinitions: ActionDefinition[] = [
  {
    ...
    inputSchema: {
      ...
      participants: { type: "json", required: false },
      allowConflict: { type: "boolean", required: false },
      recurrenceFrequency: { type: "enum", required: false, enumValues: ["DAILY", "WEEKLY", "MONTHLY", "YEARLY"] },
      recurrenceInterval: { type: "number", required: false },
      recurrenceUntil: { type: "string", required: false },
      recurrenceCount: { type: "number", required: false },
    },
    riskLevelBase: "LOW",
