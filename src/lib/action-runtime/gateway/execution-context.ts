...
const ROLE_PERMISSIONS: Record<OrganizationRole, readonly string[]> = {
  [OrganizationRole.OWNER]: ["company.write", "company.fields.manage", "members.manage", "customers.write", "customers.archive", "customers.fields.manage", "products.write", "products.archive", "goals.write", "goals.archive", "quotes.write", "payments.write", "collections.write", "invoices.write", "executive_actions.write", "integrations.write", "notifications.write", "tasks.write"],
  [OrganizationRole.EXECUTIVE]: ["company.write", "company.fields.manage", "members.manage", "customers.write", "customers.archive", "customers.fields.manage", "products.write", "products.archive", "goals.write", "goals.archive", "quotes.write", "payments.write", "collections.write", "invoices.write", "executive_actions.write", "integrations.write", "notifications.write", "tasks.write"],
  [OrganizationRole.MANAGER]: ["company.write", "customers.write", "products.write", "goals.write", "quotes.write", "payments.write", "collections.write", "invoices.write", "notifications.write", "tasks.write"],
