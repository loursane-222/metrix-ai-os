...
const ROLE_PERMISSIONS: Record<OrganizationRole, readonly string[]> = {
  ...
  [OrganizationRole.MANAGER]: ["company.write", "customers.write", "products.write", "suppliers.write", "orders.write", "deliveries.write", "stock.write", "production.write", "goals.write", "quotes.write", "payments.write", "collections.write", "invoices.write", "notifications.write", "tasks.write", "field_visits.write", "financial_accounts.view"],
