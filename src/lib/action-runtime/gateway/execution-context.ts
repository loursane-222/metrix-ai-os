...
const ROLE_PERMISSIONS: Record<OrganizationRole, readonly string[]> = {
  [OrganizationRole.OWNER]: ["company.write", "company.fields.manage", "customers.write", "customers.archive", "customers.fields.manage", "products.write", "products.archive", "goals.write", "goals.archive", "quotes.write", "payments.write", "collections.write", "invoices.write", "executive_actions.write", "integrations.write", "notifications.write", "tasks.write"],
