...
export function registerStockActions(handlerRegistry: ActionHandlerRegistry): void {
  ...
  if (!handlerRegistry.hasHandler("stock.recordCount")) handlerRegistry.registerHandler("stock.recordCount", handleStockRecordCount);
  if (!handlerRegistry.hasHandler("stock.resolveVariance")) handlerRegistry.registerHandler("stock.resolveVariance", handleStockResolveVariance);
}
