...
describe("production ExecutionRuntime composition", () => {
  ...
  it("keeps registerCustomerActions duplicate-safe when re-run against the production registry", () => {
    ...
    expect(handlerRegistry.listHandlers()).toEqual([
      ...
      "calendar_event.reschedule",
      "calendar_event.status_transition",
      "calendar_event.update",
      "cardStatement.close",
      "cardStatement.open",
      "cardStatement.pay",
      "cardStatement.payment.reverse",
      ...
      "customer.unarchive",
      "customer.update",
      "delivery.addException",
      "delivery.cancel",
      "delivery.create",
      "delivery.createFromOrder",
      "delivery.recordProof",
      "delivery.transitionStatus",
      "employeeAdvance.create",
      "employeeAdvance.move",
      "employeeAdvance.movement.reverse",
      "employeeAdvance.reconcile",
      "employeeAdvance.reconciliation.reverse",
      ...
      "financialInstrument.applyToObligation",
      "financialInstrument.bounce",
      "financialInstrument.cancel",
      "financialInstrument.clear",
      "financialInstrument.register",
      "goal.archive",
      "goal.create",
      "goal.update",
      "goodsReceipt.cancel",
      ...
      "loan.create",
      "loan.draw",
      "loan.drawdown.reverse",
      "loan.installment.repay",
      "loan.repayment.reverse",
      "machine.archive",
      "machine.create",
