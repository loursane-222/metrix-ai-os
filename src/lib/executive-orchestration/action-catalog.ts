...
const ACTION_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  "delivery.recordProof": "Bir irsaliyeye teslim kanıtı (onay kodu ve/veya teslim alan kişi) kaydeder.",
  "delivery.addException": "Bir irsaliyeye teslimat istisnası (müşteri adreste yoktu, ürün hasarlı, vb.) kaydeder.",
  "delivery.createFromOrder": "Bir siparişten, müşteri ve kalemleri otomatik türeterek irsaliye oluşturur.",
