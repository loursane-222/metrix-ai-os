...
- **Hâlâ gerçekten açık:** Paralel yürütme, bağımlılık grafiği, exception/learning intelligence — motor hâlâ sıralı/tek-yönlü çalışıyor. Bu, dış bir bağımlılığa (ortaklık, sağlayıcı hesabı, kararı) bağlı olmayan tek büyük orkestrasyon boşluğu.
